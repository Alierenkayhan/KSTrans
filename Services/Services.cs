...
public class FilesService : GenericRepository<Files> { public FilesService(IOptions<DatabaseSettings> settings) : base(settings) { } }
public class ImageService : GenericRepository<Image> { public ImageService(IOptions<DatabaseSettings> settings) : base(settings) { } }
